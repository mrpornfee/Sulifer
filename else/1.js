/*! 1 2014-07-30 */
var _config = {
    color: {allTime: 60, addTime: 0, lvMap: [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]},
    pic: {
        isOpen: !1,
        allTime: 5,
        addTime: 0,
    ...
    imgUrl: "http://game.shjytan.cn/games/se/assets/img/find.logo.png",
    timeLineLink: "http://game.uixsj.cn/se/",
    tTitle: "看你有多色？",
    tContent: "找出所有色块中颜色不同的一块。找到身边的色魔"
};
!function () {
    var a = $("#box"), b = {
        lv: $("#room .lv em"),
    ...
    var b = {index: $("#index"), room: $("#room"), loading: $("#loading"), dialog: $("#dialog"), play: $(".play-btn")},
        c = {
            init: function () {
    ...
    var a = $("#box"), b = "span", c = $("#help p"), d = $("#help_color"), e = {
        lvT: ["瞎子", "色盲", "色郎", "色狼", "色鬼", "色魔", "超级色魔", "变态色魔", "孤独求色"], render: function (e, f) {
            ...
            var b = 15 > a ? 0 : Math.ceil((a - 15) / 5), c = this.lvT[b] || _.last(this.lvT), d = c + "lv" + (a + 1),
                e = 2 * a;
